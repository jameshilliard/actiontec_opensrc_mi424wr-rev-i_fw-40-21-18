/****************************************************************************
 *
 * rg/vendor/jstream/jiwis8xx/modules/arch.c
 * 
...
MACHINE_START(JIWIS800, "JI-WIS 800 HomeGateway")
	MAINTAINER("JStream") 
...
MACHINE_START(JIWIS832, "JI-WIS 832 HomeGateway")
	MAINTAINER("JStream") 
	/*       Memory Base, Phy IO,    Virtual IO */
	BOOT_MEM(PHYS_OFFSET, IXP425_PERIPHERAL_BASE_PHYS,
		IXP425_PERIPHERAL_BASE_VIRT)
...
MACHINE_START(JIWIS842, "JI-WIS 842 HomeGateway")
	MAINTAINER("JStream") 
	/*       Memory Base, Phy IO,    Virtual IO */
	BOOT_MEM(PHYS_OFFSET, IXP425_PERIPHERAL_BASE_PHYS,
		IXP425_PERIPHERAL_BASE_VIRT)
