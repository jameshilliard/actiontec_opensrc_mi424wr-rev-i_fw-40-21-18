...
#define ehci_readl(x,reg) readl(reg)
#define ehci_writel(x,val,reg) writel(val,reg)
#endif
...
#if defined(CONFIG_ARCH_FEROCEON_KW) || defined(CONFIG_ARCH_FEROCEON_MV78XX0) || defined(CONFIG_ARCH_FEROCEON_KW2)
	u32 __iomem 	*reg_ptr;
...
#endif /* CONFIG_ARCH_FEROCEON_KW || CONFIG_ARCH_FEROCEON_MV78XX0 || CONFIG_ARCH_FEROCEON_KW2*/
}
