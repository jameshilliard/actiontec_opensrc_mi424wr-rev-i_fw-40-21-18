...
static void board_hwcontrol(struct mtd_info *mtd, int cmd)
{
	...
	case NAND_CTL_SETCLE: 
	    this->IO_ADDR_W = (void __iomem *)((unsigned long)this->IO_ADDR_W | 0x1); /*x8=>1, x16=>2*/
	    break;
	case NAND_CTL_CLRCLE:
	    this->IO_ADDR_W = (void __iomem *)((unsigned long)this->IO_ADDR_W & ~0x1); /*x8=>1, x16=>2*/
	    break;
	case NAND_CTL_SETALE:
	    this->IO_ADDR_W = (void __iomem *)((unsigned long)this->IO_ADDR_W | 0x2); /*x8=>2, x16=>4*/
	    break;
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(2,6,18)
		this->enable_hwecc	= mv_nand_enable_hwecc;
		this->calculate_ecc	= mv_nand_calculate_ecc_rs;
		this->correct_data	= mv_nand_correct_data_rs;
		this->eccsize		= 512;
		this->eccbytes		= 10;
		this->autooob		= &mv_nand_rs_oobinfo;
