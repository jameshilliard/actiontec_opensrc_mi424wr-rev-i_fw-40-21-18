 ...
 *
 * $Log: object.h,v $
 * Revision 1.5  2006/04/26 10:15:02  olegy
 * B31918 - importing new 1.10.0 pwlib, 1.18.0 openh323 versions
 *
 * Revision 1.4  2005/12/14 10:41:20  itay
 ...
 * B26090 compilation fixes for voip H.323 with uClibc++ streams (STL)
 *
 * Revision 1.3  2005/08/14 09:56:08  dmitry
 * B25117. Merged pwlib version 1_9_0 from vendor branch.
 *
 * Revision 1.2.2.1  2005/08/14 09:50:25  dmitry
 * Added pwlib version 1.9.0 from pwlib-v1_9_0-src-tar.gz
 *
 * Revision 1.2.2.2  2006/04/16 11:39:43  olegy
...
#define PI_DIFF(name, type) \
  struct name { \
    ...
    friend istream & operator>>(istream & s, name & v) { type val = 0; s >> val; v = val; return s; } \
    private: type data; \
  }
...
/* Causes compilation problems with uClibc++ */
#if 0
