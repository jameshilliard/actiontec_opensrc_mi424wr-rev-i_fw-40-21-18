 ...
 *
 * $Log: pchannel.cxx,v $
 * Revision 1.5  2006/04/26 10:16:09  olegy
 * B31918 - importing new 1.10.0 pwlib, 1.18.0 openh323 versions
 *
 * Revision 1.4  2005/12/14 10:41:21  itay
 * AUTO MERGE: 1 <- branch-4_1
 * B26090 compilation fixes for voip H.323 with uClibc++ streams (STL)
 * NOTIFY: automerge
 *
 * Revision 1.3.2.1  2005/12/14 10:40:41  itay
 * B26090 compilation fixes for voip H.323 with uClibc++ streams (STL)
 *
 * Revision 1.3  2005/08/14 09:57:44  dmitry
 * B25117. Merged pwlib version 1_9_0 from vendor branch.
 *
 * Revision 1.2.2.1  2005/08/14 09:52:25  dmitry
 * Added pwlib version 1.9.0 from pwlib-v1_9_0-src-tar.gz
 *
 * Revision 1.2.2.2  2006/04/16 11:41:04  olegy
...
#ifdef __USE_STL__
ios::pos_type PChannelStreamBuffer::seekoff(off_type off, ios_base::seekdir dir, ios_base::openmode)
#else
...
#ifdef __USE_STL__
ios::pos_type PChannelStreamBuffer::seekpos(pos_type pos, ios_base::openmode mode)
{
