 ...
 *
 * $Log: mediafmt.cxx,v $
 * Revision 1.4  2006/04/17 13:32:35  olegy
 * B29509 - calle informed about G726 codec
 *
 * Revision 1.3  2006/04/04 16:02:03  olegy
 * AUTO MERGE: 1 <- branch-4_2
 * B29509 - about G722 the callee is informed, g726 in progress
 * NOTIFY: automerge
 *
 * Revision 1.2.8.1  2006/04/04 16:01:51  olegy
 * AUTO MERGE: branch-4_2 <- branch-4_1
 * B29509 - about G722 the callee is informed, g726 in progress
 * NOTIFY: automerge
 *
 * Revision 1.2.2.2  2006/04/17 12:59:55  olegy
 * B29509 - calle informed about G726 codec
 *
 * Revision 1.2.2.1  2006/04/04 16:01:37  olegy
 * B29509 - about G722 the callee is informed, g726 in progress
 *
 * Revision 1.2  2005/08/14 09:16:48  dmitry
 * Meging initial version on dev from vendor branch. (tag openh323-1_17_1).
 *
 * Revision 1.1.2.1  2005/08/14 09:07:24  dmitry
...
char OpalG722_64k[] = OPAL_G722_64k;

OPAL_MEDIA_FORMAT_DECLARE(OpalG722_64kFormat,
    OpalG722_64k,
    OpalMediaFormat::DefaultDataSessionID,
    RTP_DataFrame::G722,
    TRUE, // Needs jitter
...
char OpalG726_32k[] = OPAL_G726_32k;

OPAL_MEDIA_FORMAT_DECLARE(OpalG726_32kFormat,
    OpalG726_32k,
    OpalMediaFormat::DefaultDataSessionID,
    RTP_DataFrame::G726,
    TRUE, // Needs jitter
