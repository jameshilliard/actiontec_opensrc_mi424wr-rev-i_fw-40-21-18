 ...
 *
 * Version Info: $Id: chan_h323.h,v 1.11 2006/05/08 09:23:26 olegy Exp $
 */
...
/* Default options to use when local options are empty */
extern call_options_t h323_options;

#define H323_DTMF_RFC2833			(1 << 0)
#define H323_DTMF_INBAND			(1 << 1)
#define H323_DTMF_Q931_KEYPAD		(1 << 2)
#define H323_DTMF_H245_ALPHANUMERIC	(1 << 3)
#define H323_DTMF_H245_SIGNAL		(1 << 4)
...
extern "C" {
	...
	void h323_callback_register(setup_incoming_cb,  
				    ...
				    hangup_cb,
				    setcapabilities_cb);
	int h323_set_capabilities(const char *, int, int, struct ast_codec_pref *);
	int h323_set_alias(struct oh323_alias *);
	int h323_set_gk(int, char *, char *, char *, char *);
	void h323_set_gk_time_to_live(int seconds);
	int h323_is_registered_with_gk(void);
	void h323_set_id(char *);
	void h323_show_tokens(void);
	void h323_set_tcp_ports(int, int);
