 ...
 *
 * Version Info: $Id: ast_h323.h,v 1.7 2006/04/17 13:32:33 olegy Exp $ 
 */
...
/**This class describes the G.722 codec capability.
 */
class H323_G722Capability : public H323AudioCapability
{
    PCLASSINFO(H323_G722Capability, H323AudioCapability);
  public:
    	H323_G722Capability();
	PObject * Clone() const;
	virtual H323Codec * CreateCodec(H323Codec::Direction direction) const;
...
class H323_G726Capability : public H323NonStandardAudioCapability
{
  PCLASSINFO(H323_G726Capability, H323NonStandardAudioCapability);
...
class MyH323Connection : public H323Connection {
	...
	void SetCapabilities(int, int, struct ast_codec_pref *);
