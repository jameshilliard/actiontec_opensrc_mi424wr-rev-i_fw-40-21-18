...
cluster_parse (struct in_addr * pnt, int length)
{
  ...
  cluster = hash_get (cluster_hash, &tmp, (void * (*) (void *))cluster_hash_alloc);
  cluster->refcnt++;
  return cluster;
}
...
cluster_intern (struct cluster_list *cluster)
{
  ...
  find = hash_get (cluster_hash, cluster, (void * (*) (void *))cluster_hash_alloc);
  find->refcnt++;
...
cluster_init (void)
{
  cluster_hash = hash_create ((unsigned int (*) (void *))cluster_hash_key_make, (int (*) (void *, void *))cluster_hash_cmp);
}

...
transit_intern (struct transit *transit)
{
  ...
  find = hash_get (transit_hash, transit, (void * (*) (void *))transit_hash_alloc);
  if (find != transit)
...
transit_init (void)
{
  transit_hash = hash_create ((unsigned int (*) (void *))transit_hash_key_make, (int (*) (void *, void *))transit_hash_cmp);
}

...
attrhash_init (void)
{
  attrhash = hash_create ((unsigned int (*) (void *))attrhash_key_make, (int (*) (void *, void *))attrhash_cmp);
}
...
bgp_attr_intern (struct attr *attr)
{
  ...
  find = (struct attr *) hash_get (attrhash, attr, (void * (*) (void *))bgp_attr_hash_alloc);
  find->refcnt++;
  ...
  while (BGP_INPUT_PNT (peer) < endp)
      ...
      if (endp - BGP_INPUT_PNT (peer) < BGP_ATTR_MIN_LEN)
	{
	  ...
	  zlog (peer->log, LOG_WARNING, 
		...
		peer->host, (long)(endp - STREAM_PNT (BGP_INPUT (peer))));
