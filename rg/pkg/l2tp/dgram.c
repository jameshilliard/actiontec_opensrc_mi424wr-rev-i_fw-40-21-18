...
***********************************************************************/
l2tp_dgram *
l2tp_dgram_take_from_wire(int sock, struct sockaddr_in *from)
{
...
***********************************************************************/
int
l2tp_dgram_send_to_wire(int sock,
			  ...
			  int len)
{
    ...
    r = sendto(tunnel->sock, real_buf, len+8, 0,
