...
{
    static char buff[1024], iface[16], flags[64];
    static char gate_addr[128], net_addr[128];
    static char mask_addr[128];
...
{
    static char buff[1024], iface[16], flags[64];
    static char gate_addr[128], dest_addr[128], specdst[128];
    static char src_addr[128];
