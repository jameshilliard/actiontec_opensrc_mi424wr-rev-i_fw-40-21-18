...
struct sadb_x_debug {
  ...
  uint32_t sadb_x_debug_reject;
  uint32_t sadb_x_debug_log_all;
  uint8_t aligned[4];
};
...
#define SADB_X_EXT_ADDRESS_SRC_TO     25
#define SADB_X_EXT_ADDRESS_DST_TO     26
#define SADB_X_EXT_DEBUG              27
#define SADB_X_EXT_PROTOCOL	      28
#define SADB_X_EXT_NAT_T_TYPE         29
#define SADB_X_EXT_NAT_T_SPORT        30
#define SADB_X_EXT_NAT_T_DPORT        31
#define SADB_X_EXT_NAT_T_OA           32
