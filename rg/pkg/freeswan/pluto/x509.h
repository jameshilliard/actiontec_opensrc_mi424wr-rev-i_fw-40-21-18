 ...
 */
#define X509_CERT_PATH	  "/etc/x509cert.der"
 ...
 *  flag set in main.c and used in ipsec_doi.c and kernel_comm.c
 */
...
extern bool check_validity(const x509cert_t *cert, time_t *until);
