...
typedef struct Hjava_lang_Integer {
...
#undef java_lang_Integer_MIN_CACHE
#define java_lang_Integer_MIN_CACHE -128L
#undef java_lang_Integer_MAX_CACHE
#define java_lang_Integer_MAX_CACHE 127L
  jint value;
} Hjava_lang_Integer;
