...
#define LTRACE() fprintf(stderr,"[%s %4d]in %s\n",__FILE__,__LINE__,__FUNCTION__);
#define LOOP()	do {sleep(1);}while(1)

#if defined(ALL_INCLUSIVE) || defined(NO_SHARED_LIBS)
#	ifdef _INIT
#		undef _init_ip6t
#		define _init_ip6t _INIT
#	else
#		define _init_ip6t __attribute__((constructor)) _init_function
//#		define _init_ip6t __attribute__((unused)) _init_function
#	endif
	extern void init_extensions(void);
#else
#	define _init_ip6t __attribute__((constructor)) _INIT
#endif
