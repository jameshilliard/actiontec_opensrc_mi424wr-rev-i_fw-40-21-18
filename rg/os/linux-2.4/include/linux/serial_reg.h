...
/* Non-standard serial register for Conexant's board */
#define UART_IER_MSI	0x00	/* Enable Modem status interrupt */
#define UART_IER_RLSI	0x02	/* Enable receiver line status interrupt */
#define UART_IER_THRI	0x20	/* Enable Transmitter holding register int. */
