...
#ifndef CONFIG_DISABLE_NETDEV_MODIFYING
	void *kos_priv;	/* pointer to KOS private data	*/
#endif
};
...
extern int net_run_sbin_hotplug(struct net_device *dev, char *action);
#else
