...
extern struct hw_pci jiwis8xx_pci;
extern struct hw_pci aei_ixp4xx_pci;
...
void __init pcibios_init(void)
{
	...
	do {
		...
		if (machine_is_jiwis800() || machine_is_jiwis832() ||
		    machine_is_jiwis842()) {
			hw = &jiwis8xx_pci;
		}
		if (machine_is_mi424wr() || machine_is_vi414wg() || 
		    machine_is_ki414wg() || machine_is_ri408()) {
			hw = &aei_ixp4xx_pci;
			break;
		}
		} while (0);
