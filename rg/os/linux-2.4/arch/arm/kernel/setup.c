...
static int __init parse_tag_imgstart(const struct tag *tag)
{
	kernel_image_start = tag->u.imgstart.addr;
	return 0;
}

__tagtable(ATAG_IMGSTART, parse_tag_imgstart);
