...
void iq31244_init(void*);
int iq31244_map_irq(struct pci_dev *, unsigned char, unsigned char);


struct hw_pci iq31244_pci __initdata = {
	init:		iq31244_init,
...
iq31244_init(void *data)
{
	...
	// Need to update this for IQ31244, not a slave card
	/*
...
iq31244_map_irq(struct pci_dev *dev, unsigned char idsel, unsigned char pin)
{
        char ret;

        static char pci_irq_table[4][4] =
                {
                        /*
                         * PCI IDSEL/INTPIN->INTLINE
                         * A       B       C       D
                         */
			{INTB, INTB, INTB, INTB},    // Not used
                        {INTC, INTC, INTC, INTC},    // GD31244 SATAs
			{INTD, INTD, INTD, INTD},    // PCI-X Slot
                        {INTA, INTA, INTA, INTA},    // 82546 GigE
										                };
