...
/* In IXP425 we force pci allocations to fall into the DMAble window (first 
 * 64M). Otherwise PCI controller will be unable to access the data.
 */
#if defined(CONFIG_PCI) && !defined(CONFIG_IXP425) || defined(CONFIG_SA1111)
