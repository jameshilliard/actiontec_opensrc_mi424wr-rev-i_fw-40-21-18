...
char zft_src[] __initdata = "$Source: /home/cvsroot/jungo/rg/os/linux-2.4/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2007/05/07 23:29:35 $";
