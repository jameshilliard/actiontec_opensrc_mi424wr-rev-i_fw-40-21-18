...
/*
 * Copied code from kernel 2.2 so that the pppd will not fail for PPTP Server
 * connections.
 */
	case PPPIOCGFLAGS:
	case PPPIOCSFLAGS:
...
/* This code was also taken from kernel 2.2, it is not strictly needed and the
 * function doesn't exists anymore.
	case PPPIOCATTACH:
	case PPPIOCDETACH:
