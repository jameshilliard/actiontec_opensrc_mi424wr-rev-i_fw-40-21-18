...
{
#ifdef CUSTOM_IDE_IO
    return custom_ide_insw(port, addr, count);
#else
...
{
#ifdef CUSTOM_IDE_IO
    custom_ide_insl(port ,addr, count);
#else
...
{
#ifdef CUSTOM_IDE_IO
    custom_ide_outbsync(drive, addr, port);
#else
    outb(addr, port);
#endif
}
...
{
#ifdef CUSTOM_IDE_IO
    custom_ide_outsw(port, addr, count);
#else
...
{
#ifdef CUSTOM_IDE_IO
    custom_ide_outsl(port, addr, count);
#else
...
#define SWAP_BYTES(a, b) { unsigned char temp = (a); (a) = (b); (b) = temp; }

#define SWAP_LONG(l) (l) = ((__u32)( \
	(__u32)(((__u32)(l) & (__u32)0xffff0000UL) >> (__u32)16) | \
	(__u32)(((__u32)(l) & (__u32)0x0000ffffUL) << (__u32)16) ))

#define SWAP_LONGLONG(l) (l) = ((__u64)( \
	(__u64)(((__u64)(l) & (__u64)0xffff000000000000ULL) >> (__u64)48) | \
	(__u64)(((__u64)(l) & (__u64)0x0000ffff00000000ULL) >> (__u64)16) | \
	(__u64)(((__u64)(l) & (__u64)0x00000000ffff0000ULL) << (__u64)16) | \
	(__u64)(((__u64)(l) & (__u64)0x000000000000ffffULL) >> (__u64)48) ))

void ide_fix_driveid(struct hd_driveid *id)
{
    SWAP_BYTES(id->max_multsect, id->vendor3);
    SWAP_BYTES(id->capability, id->vendor4);
    SWAP_BYTES(id->tPIO, id->vendor5);
    SWAP_BYTES(id->tDMA, id->vendor6);
    SWAP_BYTES(id->multsect, id->multsect_valid);

    SWAP_LONG(id->lba_capacity);
    SWAP_LONGLONG(id->lba_capacity_2);
    SWAP_LONG(id->spg);
}
