 ...
 * the CPU very much.
 */
static inline void cpu_probe_fusiv(struct cpuinfo_mips *c)
{
	unsigned long chipid = *((unsigned long *)0xb900003c);

 	switch (chipid) {
	case 0x6834:
	case 0x6833:
	default:
		c->processor_id = (chipid << 16) | PRID_IMP_ADI_FUSIV;
