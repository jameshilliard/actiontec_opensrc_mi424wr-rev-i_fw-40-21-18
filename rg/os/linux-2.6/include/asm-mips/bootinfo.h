 ...
 */
#define MACH_GROUP_CAVIUM      24	/* Cavium Octeon */
#define  MACH_CAVIUM_OCTEON	1	/* Cavium Octeon */

#define CL_SIZE			COMMAND_LINE_SIZE

#define GROUP_CENTILLIUM_PALLADIA { "P220", "P300", "P400" }

/*
 * Valid machtype for group CENTILLIUM
 */
#define MACH_GROUP_CENTILLIUM  26 /* Palladia processors p220, p300 and p400 */
#define MACH_CENTILLIUM_P220	0
#define MACH_CENTILLIUM_P300	1
#define MACH_CENTILLIUM_P400	2
