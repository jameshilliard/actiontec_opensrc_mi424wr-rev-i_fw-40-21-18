...
#if defined(CONFIG_CENTILLIUM_P300) || defined(CONFIG_CENTILLIUM_P220) || defined(CONFIG_CENTILLIUM_P400)
#define PALLADIA_SERIAL_PORT_DEFNS	\
        { 	.baud_base = 38400,           \
        	.port = 0xA6340000,           \
      	  	.iomem_base = (u8*)0xA6340000,\
      	  	.iomem_reg_shift = 2,         \
      	  	.irq = IAD_IV_UART ,          \
      	  	.flags = STD_COM_FLAGS,       \
      	  	.io_type = SERIAL_IO_MEM },
