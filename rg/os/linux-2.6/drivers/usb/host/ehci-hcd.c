...
extern void    ehci_marvell_port_status_changed(struct ehci_hcd *ehci);
#endif
...
#if defined(CONFIG_ARCH_FEROCEON) || (!(defined(CONFIG_FUSIV_VX160)))
	int			retval;
...
#if defined(CONFIG_ARCH_FEROCEON)
		ehci_marvell_port_status_changed(ehci);
#endif /* CONFIG_ARCH_FEROCEON */
	}
