...
#define GADGET_IMMR_BASE	        (0xfe000000)
/* USB I/O pins cfg */
#define SICRL_USB0	        (0x40000000)
#define SICRL_USB1	        (0x20000000)
#define SICRH_TSCE2_F	        (0x00020000)

/* USB module clk cfg */
#define SCCR_USB_CLK_DISABLE    (0x00000000)    /* USB clk disable */
#define SCCR_USB_01_CSB_CLK     (0x00500000)    /* USB clk 1:1 CSB clk */
#define SCCR_USB_10_CSB_CLK     (0x00A00000)    /* USB clk 1:2 CSB clk */
#define SCCR_USB_11_CSB_CLK     (0x00F00000)    /* USB clk 1:3 CSB clk */
