 ...
 *
 *  $Id: 8250.c,v 1.1.1.1.2.1.42.1 2010/12/23 00:13:11 athill Exp $
 *
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: 1.1.1.1.2.1.42.1 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: 1.1.1.1.2.1.42.1 $");
